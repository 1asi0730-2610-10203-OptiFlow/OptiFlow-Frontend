    ...
    <div class="modal" @click.stop>
      ...
      <div class="modal-body">
        ...
        <div class="field field--full">
          <label class="field-label">
            ...
            {{ $t('labOrders.registerLabModal.name') }}
          ...
          <input
            ...
            :placeholder="$t('labOrders.registerLabModal.namePlaceholder')"
            @input="errors.name = false"
          />
          <span v-if="errors.name" class="field-error">
            {{ $t('labOrders.registerLabModal.nameRequired') }}
          </span>
        </div>
        ...
        <div class="form-row">
          <div class="field">
            <label class="field-label">
              ...
              {{ $t('labOrders.registerLabModal.phone') }}
              <span class="required-mark">*</span>
            </label>
            <input
              v-model="form.phone"
          ...
          <div class="field">
            <label class="field-label">
              ...
              {{ $t('labOrders.registerLabModal.email') }}
              <span class="required-mark">*</span>
            </label>
            <input
              v-model="form.email"
              ...
              :placeholder="$t('labOrders.registerLabModal.emailPlaceholder')"
              @input="errors.email = false; errors.emailFormat = false"
            />
            <span v-if="errors.email" class="field-error">
              {{ $t('labOrders.registerLabModal.emailRequired') }}
            </span>
            <span v-else-if="errors.emailFormat" class="field-error">
              {{ $t('labOrders.registerLabModal.emailInvalid') }}
            </span>
          </div>
        </div>

        <!-- Preview card -->
        <div v-if="form.name || form.phone || form.email" class="preview-card">
          <div class="preview-header">
            <i class="pi pi-eye preview-icon" />
            <span>{{ $t('labOrders.registerLabModal.preview') }}</span>
          </div>
      ...
      <div class="modal-footer">
        ...
        <button class="btn-register" @click="onRegister">
          <i class="pi pi-check" />
          {{ $t('labOrders.registerLabModal.register') }}
        </button>
      </div>
...
.preview-name {
  ...
  font-weight: 700; color: #111827; margin: 0 0 5px;
}
